        ...
        <div className="container-narrow mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="prose prose-sm text-muted-foreground space-y-6">
              ...
              <p>
                Relay AI, Inc. ("Relay," "we," "our," or "us") provides communication services for small businesses, including inbound call handling and transactional SMS messaging. <strong className="text-foreground">Relay AI, Inc. is operated by Astound Biz LLC.</strong> This Privacy Policy explains how we collect, use, and protect personal information, including mobile information.
              </p>
